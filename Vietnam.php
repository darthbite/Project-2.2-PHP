...
<body>
              ...
              <nav class="mx-auto w-50 p-0 navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                       ...
                       <li class="nav-item">
                          <a class="nav-link" href="Ukraine.php">Ukraine</span></a>
                       </li>
                       <li class="nav-item">
                         <a class="nav-link" href="Colombia.php">Colombia</a>
                       </li>
                       <li class="nav-item active">
                         <a class="nav-link" href="Vietnam.php">Vietnam<span class="sr-only">(current)</span></a>
                       </li>
                       <li class="nav-item">
    ...
    close();
     ...
     ?>
    <br>
    <h3 class="text-center">Weather Data for Vietnam</h3>
    <table class="table">
